...
// Context-aware rows. `_menus` is null only when nobody bound a MenuHost (the plain
...
std::shared_ptr<MenuView> MenuBuilder::BuildEffectPicker(MenuHost& menus, PlayerRef admin, PlayerRef target,
