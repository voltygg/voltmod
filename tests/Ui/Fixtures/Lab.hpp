...
inline constexpr std::array<Card, 2> Cards{
    Card{"lab_card0", "lab_card0_icon", "lab_card0_bar", "card0_title", "card0_subtitle", "card0_value"},
    Card{"lab_card1", "lab_card1_icon", "lab_card1_bar", "card1_title", "card1_subtitle", "card1_value"},
};
