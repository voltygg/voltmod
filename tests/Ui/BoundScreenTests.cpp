...
constexpr struct
{
    Text Title{LabUi::RootId, LabUi::ToastTitleVar};
    Text Description{LabUi::RootId, LabUi::ToastDescriptionVar};
    Choice Accent{LabUi::ToastAccent, LabUi::AccentClasses};
    Flag Show{LabUi::Toast, "Show"};
} Toast;

constexpr Flag Hidden{LabUi::RootId, "Hidden"};
...
TEST_CASE("A family finds its index by variant name")
{
    ...
    CHECK(Card[0].Icon.Find("famas") == -1);
}
