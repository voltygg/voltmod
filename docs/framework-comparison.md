...
| Events and hooks | Typed game events, listeners, SourceHook helpers, gamedata, movement hooks, and input history | Generated typed game events, listeners, function hooks, net messages, and entity input/output hooks | Game events, listeners, function hooks, user messages, and other Source 2 hooks through S2SDK | Game-event handlers, listeners, timers, virtual functions, and memory/dynamic hooks |
