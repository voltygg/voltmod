...
| Unsafe | `VoltMod/Unsafe/` | Opt-in raw hooking: `HookInterface` for an interface method, `HookClassSlot` for a gamedata-bound class slot, `HookFunction` for a signature-bound function |
