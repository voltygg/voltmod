...
| Header | Brings in |
| --- | --- |
| `<VoltMod/Entities/Api.hpp>` | `Entity`, `Pawn`, `Controller`, `EntityRef`, `AngleToForward`, `EntitySystem`, `EntityOps`, `KeyValues`, `Items`, `Pawns`, `PawnOps`, `Trace`, `Render`, `ConVar`, `ConVarOverrides` |
