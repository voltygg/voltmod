 ...
 *
 * One vote at a time. The title must be a `#SFUI_vote...` or `#Panorama_vote...` token the
 * client already has; other text does not render. Callbacks run on the game thread.
 */
class Vote
{
public:
